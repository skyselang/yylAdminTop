...
<script>
import { getMemberToken, getMemberId, getAvatar, setAvatar } from '@/utils/userinfo'
...
export default {
  ...
  data () {
    return {
      avatar: '',
      uploadAction: process.env.VUE_APP_BASE_API + '/index/Member/avatar',
      uploadHeaders: { MemberId: getMemberId(), MemberToken: getMemberToken() }
    }
  },
  created () {
    this.getAvatar()
